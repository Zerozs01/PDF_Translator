...
export const CONFIG = {
  ...
  LATIN_ANCHOR_PROBE_TOP_CENTER_Y_RATIO_MAX: 0.38,
  ...
  BORDER_ARTIFACT_EDGE_BAND_RATIO: 1.85,
  BORDER_ARTIFACT_CENTER_DARK_RATIO_MIN: 0.022,
  BORDER_ARTIFACT_COMPONENT_MIN: 2,
  BORDER_ARTIFACT_HORIZONTAL_PEAKS_MIN: 2,
